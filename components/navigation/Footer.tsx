      ...
      <div className="relative z-10 backdrop-blur-xl bg-gradient-to-b from-slate-900/80 via-slate-800/60 to-slate-900/80 border-t border-white/10">
        ...
        <div className="container mx-auto px-4 py-8 sm:py-12">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            ...
            {/* Resources */}
            <div>
              <h4 className="text-base sm:text-lg font-semibold text-white mb-3 sm:mb-4">Recursos</h4>
              <ul className="space-y-3">
                <li>
                  <a 
            ...
            {/* Support */}
            <div>
              <h4 className="text-base sm:text-lg font-semibold text-white mb-3 sm:mb-4">Soporte</h4>
              <ul className="space-y-3">
                <li>
                  <Link 
                    href="/debug" 
